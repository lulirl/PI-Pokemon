  ...
  process.env.NODE_ENV === "production"
    ? new Sequelize({
        ...
        dialectOptions: {
          ssl: {
            require: true,
            //Ref.: https://github.com/brainc/node-postgres/issues/2009
    ...
    : new Sequelize(`postgres://${DB_USER}: @${DB_HOST}/pokemon`, {
        logging: false,
        native: false,
      });

// const sequelize = new Sequelize(`postgres://${DB_USER}@${DB_HOST}/pokemon`, {
